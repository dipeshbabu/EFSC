...
def main() -> None:
    ...
    for epoch in range(args.epochs):
        ...
        if row["val_loss"] < best_val:
            ...
            torch.save(model.state_dict(), out_dir / "best_stage1_lora.pt")

    torch.save(model.state_dict(), out_dir / "last_stage1_lora.pt")
    save_json({"history": history}, out_dir / "train_log_stage1_lora.json")
